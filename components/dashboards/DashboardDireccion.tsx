  ...
  return (
    <div className="p-6 md:p-8 max-w-7xl mx-auto space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div
          id="kpi-assist"
          className="bg-black/20 backdrop-blur-xl p-6 rounded-2xl border border-white/10 shadow-lg group hover:bg-white/5 transition-all"
        >
          ...
          <ul className="space-y-3">
            ...
            <li className="flex gap-3 items-start">
              <input
                ...
                onChange={() => toggleCheck("insumos")}
                className="mt-1 rounded text-blue-500 focus:ring-blue-500 bg-gray-800 border-gray-600"
              />
              <div
                className={checklist.insumos ? "line-through opacity-50" : ""}
              >
                <p className="text-sm font-bold text-gray-200">
