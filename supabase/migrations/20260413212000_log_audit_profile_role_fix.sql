-- =====================================================
-- SASE-310: Compatibilidad final de log_audit con profiles.role
-- Fecha: 2026-04-13
-- Objetivo:
--   Ajustar public.log_audit al schema local actual donde public.profiles
--   expone role y no siempre la columna legacy rol.
-- =====================================================
...
INSERT INTO public.auditoria (
  ...
  'MIGRACION_SEGURIDAD',
  'Ajuste final de public.log_audit para usar profiles.role como fallback legacy.',
  'auditoria'
);
*** Add File: /home/hugo_system/code/SASE-310-SYSTEM/supabase/migrations/20260413214500_log_audit_column_alignment.sql
-- =====================================================
