...
export const Login: React.FC<LoginProps> = ({
  ...
  const handleAdminBypass = () => {
    ...
    const validPin = import.meta.env.VITE_ADMIN_PIN || "31416";
    if (pin === validPin) {
      alert(
  ...
  return (
    <div className="relative h-screen w-full flex flex-col items-center font-sans overflow-x-hidden overflow-y-auto">
      {/* 0. FIXED BACKGROUND IMAGE LAYER */}
      <div className="fixed inset-0 z-0 bg-[url('/assets/branding/login_background_final.png')] bg-cover bg-center bg-no-repeat pointer-events-none"></div>
      ...
      <div
        className={`fixed inset-0 bg-[#0f1014]/60 backdrop-blur-sm z-10 transition-opacity duration-1000 pointer-events-none ${
      ...
      {/* 3. LOGIN CARD */}
      <div
        className={`relative z-20 w-full max-w-[480px] my-auto mx-4 transition-all duration-1000 transform ${
          showForm
        ...
        <div className="bg-[#0f172a]/40 backdrop-blur-md border border-white/10 rounded-[3rem] p-12 shadow-[0_0_150px_rgba(0,0,0,0.8)] relative overflow-hidden group">
          ...
          <div className="flex flex-col items-center">
            ...
            <button
              ...
              className="w-full text-slate-500 hover:text-blue-400 text-[11px] font-bold py-2 transition-all uppercase tracking-widest opacity-70 hover:opacity-100 flex items-center justify-center gap-2 mb-6"
            >
