...
export const ExternalModuleLauncher: React.FC<{
  ...
  return (
    <div className={`flex h-full min-h-0 w-full flex-col overflow-hidden ${
      status === "embedded" && iframeUrl ? "p-0" : "p-4 md:p-6"
    } bg-[var(--sase-bg)] bg-[radial-gradient(circle_at_0%_0%,rgba(129,106,184,0.15),transparent_45%),radial-gradient(circle_at_100%_0%,rgba(59,130,246,0.12),transparent_45%),radial-gradient(circle_at_50%_100%,rgba(175,166,60,0.10),transparent_50%)]`}>
      {status === "embedded" && iframeUrl ? (
        <div className="flex h-full min-h-0 w-full flex-1 flex-col overflow-hidden border-0 bg-[rgba(17,24,39,0.72)]">
          <div className="flex shrink-0 items-center justify-between px-5 py-4 border-b border-white/10 bg-[rgba(11,10,14,0.82)]">
          ...
          <div className="relative min-h-0 flex-1 overflow-hidden bg-[#0b0a0e]">
            {!iframeReady && (
        ...
        <div className="flex min-h-0 w-full flex-1 items-center justify-center overflow-y-auto py-4">
          <motion.div
            ...
            className="flex max-h-full w-full max-w-md flex-col bg-[rgba(17,24,39,0.78)] backdrop-blur-[34px] rounded-3xl shadow-[0_36px_90px_rgba(0,0,0,0.46),0_0_34px_rgba(129,106,184,0.16)] overflow-hidden border border-white/10"
          >
            <div className="shrink-0 bg-[rgba(11,10,14,0.74)] p-8 flex justify-center relative overflow-hidden border-b border-white/10">
            ...
            <div className="min-h-0 flex-1 overflow-y-auto p-8 text-center text-slate-100">
            ...
            <div className="shrink-0 px-8 py-4 bg-[#0b0a0e]/80 border-t border-white/10 text-[10px] text-slate-500 text-center uppercase tracking-widest font-bold">
