  ...
  const handleSaveEvent = async () => {
    ...
    try {
      ...
      const savedEvent: CalendarEvent = {
        ...
        title: data.titulo,
        date: data.fecha,
        time: data.hora ? data.hora.slice(0, 5) : undefined,
            ...
            <div className="p-8 space-y-5">
              ...
              <div className="space-y-1.5">
                ...
                >
                  ...
                  <option value="evento">Evento Cívico/Escolar</option>
                  <option value="evaluacion">Evaluación Académica</option>
                  <option value="festivo">Día Festivo / Suspensión</option>
                </select>
              </div>
